...
class BootstrapHtmlHelper extends HtmlHelper {    
    ...
    **/
    public function getCrumbList($options = array(), $startText = null) {
        $options['separator'] = '' ;
        $options = $this->addClass($options, 'breadcrumb well') ;
    ...
    **/
    ...
    public function paginator(){
    	...
    	$options = array('tag'=>'li','before'=>'<ul class="pagination">', 'after'=>'</ul>', 'separator'=>false, 'currentClass'=>'active','currentTag'=>'a');
    	$this->Paginator = new PaginatorHelper($this->_View);
